"""
Django settings for onechan_django project.
...
SECRET_KEY = 'twpm_ht+_o3455z_mrq8(y0r4*%plnbc#a#2%&3d*7pr3k64)k'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'onechan.utils.favourites.favourites'
            ],
        },
    },
]

WSGI_APPLICATION = 'onechan_django.wsgi.application'
